#------------------------------------------------------------------------------------------------#
#  Payout URL Generator --- Tested using Python 3.9.2
#------------------------------------------------------------------------------------------------#
...
DEFAULT_BASE_URL =  "https://www3.hhu.de/lab/dice.php"
...
class PayoutURLGenerator():
    ...
    def __init__(self, expShortName : str = None, expId : str = None, pid : str = None, payout : float = None, baseURL : str = DEFAULT_BASE_URL):
        ...
        self.currView : str = 'paymentdatasubmitform'
    ...
    def setExpId(self, expId : str) -> None:
        '''Set the expId parameter for the url generator'''
        self.expId = expId
    
    def setExpId(self, expId : int) -> None:
        '''Set the expId parameter for the url generator'''
    ...
    def __encodeBase64(self, expDictStr : str) -> str:
        ...
        message_bytes : str = expDictStr.encode()
